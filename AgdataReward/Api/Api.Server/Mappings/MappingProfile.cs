...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<RewardPoints, RewardPointsCreateDto>().ReverseMap();
        CreateMap<RewardTransaction, RewardTransactionDto>().ReverseMap();
        CreateMap<RewardTransaction, RewardTransactionCreateDto>().ReverseMap();
        CreateMap<RewardTransaction, RewardTransactionUpdateDto>().ReverseMap();
        ...
        CreateMap<UserProfileCreateDto, UserProfile>()
            .ConstructUsing(dto => new UserProfile(
                Guid.NewGuid(),
                new Domain.ValueObjects.EmployeeId(dto.EmployeeId),
                new Domain.ValueObjects.Email(dto.Email),
                dto.FirstName,
                dto.LastName,
                Enum.Parse<Domain.Enums.UserRole>(dto.Role, true)
            ));

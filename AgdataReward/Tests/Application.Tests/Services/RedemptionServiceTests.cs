...
public class RedemptionServiceTests
{
    ...
    public async Task RequestRedemption_ShouldThrow_IfInsufficientPoints()
    {
        ...
        // Act
        Func<Task> act = () => service.RequestRedemptionAsync(account.UserId, product.Id);

        // Assert
        await Assert.ThrowsAsync<InsufficientPointsException>(act);
    }
    ...
    public async Task RequestRedemption_ShouldThrow_IfProductOutOfStock()
    {
        ...
        // Assert
        await Assert.ThrowsAsync<InvalidRedemptionException>(act);
    }
    ...
    public async Task CompleteRedemption_ShouldThrow_IfNotApproved()
    {
        ...
        // Act
        Func<Task> act = () => service.CompleteRedemptionAsync(redemption.Id);

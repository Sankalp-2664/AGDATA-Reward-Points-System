...
public class UserServiceTests
{
    ...
    public async Task RegisterUser_ShouldThrow_IfEmployeeIdIsNullOrEmpty(string employeeId)
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync(employeeId, "user@agdata.com", "Sankalp", "C", UserRole.User);
    ...
    public async Task RegisterUser_ShouldThrow_IfEmailIsNullOrInvalid(string email)
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync("EMP123", email, "Sankalp", "C", UserRole.User);
    ...
    public async Task RegisterUser_ShouldThrow_IfFirstNameIsNullOrEmpty(string firstName)
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync("EMP123", "user@agdata.com", firstName, "C", UserRole.User);
    ...
    public async Task RegisterUser_ShouldThrow_IfLastNameIsNullOrEmpty(string lastName)
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync("EMP123", "user@agdata.com", "Sankalp", lastName, UserRole.User);
    ...
    public async Task RegisterUser_ShouldThrow_IfEmployeeIdAlreadyExists()
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync("EMP001", "second@agdata.com", "Second", "Name", UserRole.User);
    ...
    public async Task RegisterUser_ShouldThrow_IfEmailAlreadyExists()
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync("EMP002", "duplicate@agdata.com", "Bob", "Brown", UserRole.User);
    ...
    public async Task RegisterUser_ShouldThrow_IfEmailMissingAtSymbol()
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync("EMP500", invalidEmail, "Sankalp", "C", UserRole.User);
    ...
    public async Task RegisterUser_ShouldThrow_IfUserRoleInvalid()
    {
        ...
        // Act
        Func<Task> act = () => service.RegisterUserAsync("EMP888", "valid@agdata.com", "Sankalp", "Chakre", invalidRole);
